...
public class DateUtil {
    ...
    public static String dateToString(String template, Date date) {
    ...
    public static int getDistance(String strDate1, String strDate2) {
        int distance = 0;
        Date date1 = getDate(strDate1, "yyyy-MM-dd");
        Date date2 = getDate(strDate2, "yyyy-MM-dd");
    ...
    /**
     * 比较时间前后顺序如果time1早于(小于)time2则返回true
     *
     * @param time1
     * @param time2
     * @return
