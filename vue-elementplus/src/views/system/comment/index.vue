<template>
<el-dialog :title="dialog.title" v-model="dialog.visible" @close="closeDialog" destroy-on-close appendToBody :close-on-click-modal=false width="80%">
    <el-card class="card" shadow="never">
        <template #header>
            <el-form :inline="true" :model="searchForm" ref="searchFormRef">
               
                 <el-form-item prop="user_id" label="评论用户">
                ...
                <el-form-item>
                    <el-button type="success" plain :icon="Search" @click="handleQuery" >搜索</el-button>
                    <el-button type="info" plain :icon="Refresh" @click="handleRest" >重置</el-button>
                </el-form-item>
            </el-form>
            <div>
        ...
        <el-table :data="pageTableData.list" border style="width: 100%" @selection-change="handleSelectionChange" @cell-dblclick="handleCellDblclick" :header-cell-style="{fontSize: '13px !important' ,color:'#111  !important'}"  stripe  size="large">
            ...
            <el-table-column type="selection" width="55" />
             ...
             <el-table-column prop="user" label="评论用户">
                <template #default="scope">
            ...
            <el-table-column fixed="right" align="center" label="操作" width="180">
                <template #default="scope">
                    <el-button :icon="ChatDotSquare"     type="success" @click="openDialog(scope.row.id)" plain size="small" >回复</el-button>
...
const openDeleteDialog = (ids) => {
    ElMessageBox.confirm(`确认删除已选中的数据项?`, '警告', {
        ...
        //调用删除接口API
        await instances.post("/comment/delete/",ids).then((res) => {
